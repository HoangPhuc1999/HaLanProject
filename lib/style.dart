...
final ThemeData themeData = ThemeData(
  ...
  backgroundColor: AppColor.borderTrip,
...
const ButtonThemeData buttonThemeData = ButtonThemeData(
  disabledColor: AppColor.halan_orange_10,
  buttonColor: AppColor.halan_orange_10,
...
final AppBarTheme appBarTheme = AppBarTheme(
  ...
  actionsIconTheme: iconThemeData.copyWith(color: AppColor.black),
  textTheme: textTheme.copyWith(headline6: textTheme.headline6.copyWith(color: AppColor.black)),
);
